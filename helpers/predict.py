...
def get_text_classification(image):
    ...
    text_classification = features.ocr.get_text_classification(image)
...
def get_image_classification(image, model):
    ...
    #classify each image
    name, plot, table, other, classification = prediction.prediction.get_prediction(image, model, 0.6)
